  ...
  exportExcel() {
    ...
    this.responseData.forEach(element => {
      const obj = {
        ...
        'Implication': element.task_implication,
        'Owner': element.task_executor,
        'Approver': element.task_evaluator,
        'Function Head': element.task_function_head,
  ...
  exportPDF() {
    ...
    this.responseData.forEach(element => {
      var temp = [
        ...
        element.tsk_impact,
        element.task_implication,
        element.task_executor,
        element.task_evaluator,
        element.task_function_head,
